...
local function checkReqs(player, npc, bfid, registrant)
    ...
    local registerReqs =
    {
        ...
        [  37] = function() return ( player:getQuestStatus(xi.quest.log_id.JEUNO, xi.quest.id.jeuno.MIRROR_MIRROR) == QUEST_ACCEPTED and player:getCharVar("[Quest]Mirror_Mirror") == 2    ) end, -- Quest: Mirror Mirror
        ...
        -- [ 532] = function() return (acp >= mi.acp.THOSE_WHO_LURK_IN_SHADOWS_III and player:hasKeyItem(xi.ki.MARK_OF_SEED)                                                  ) end, -- Those Who Lurk in Shadows (ACP7)
        ...
        [ 992] = function() return ( cop == mi.cop.ONE_TO_BE_FEARED and player:getCharVar('Mission[6][638]Status') >= 2                                                    ) end, -- PM6-4: One to be Feared
        ...
        [1057] = function() return ( player:getCharVar("Quest[3][89]Prog") == 3                                                                                            ) end, -- Apocalypse Nigh
    ...
    local enterReqs =
    {
        ...
        [ 992] = function() return ( cop > mi.cop.ONE_TO_BE_FEARED                                                                                         ) end, -- PM6-4: One to be Feared
