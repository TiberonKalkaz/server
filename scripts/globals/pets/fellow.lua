...
function checkBuff(mob, master, fellowLvl, mp, fellowType)
    ...
    if master:getFellowValue("job") == FELLOW_TYPE_SOOTHING then
        ...
        {
            [xi.job.WHM] = function (x) buffs[xi.effect.HASTE].job[6][2] = 80 end,
            [xi.job.BLM] = function (x) buffs[xi.effect.HASTE].job[6][2] = 80 end,
            [xi.job.RDM] = function (x) buffs[xi.effect.HASTE].job[6][2] = 80 end,
            [xi.job.BRD] = function (x) buffs[xi.effect.HASTE].job[6][2] = 80 end,
            [xi.job.RNG] = function (x) buffs[xi.effect.HASTE].job[6][2] = 80 end,
            [xi.job.SMN] = function (x) buffs[xi.effect.HASTE].job[6][2] = 80 end,
            [xi.job.COR] = function (x) buffs[xi.effect.HASTE].job[6][2] = 80 end,
            [xi.job.SCH] = function (x) buffs[xi.effect.HASTE].job[6][2] = 80 end,
        }
    end
